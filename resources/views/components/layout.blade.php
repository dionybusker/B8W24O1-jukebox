...
<html lang="en">
    ...
    <body>
            ...
            <nav class="flex items-center justify-between flex-wrap p-6">
                ...
                <div data-nav-content="" class="w-full block flex-grow lg:flex items-center lg:w-auto hidden">
                    <div class="text-sm lg:flex-grow">
                        ...
                        <a href="/playlists" class="block lg:inline-block lg:text-center lg:w-24 lg:mt-0 lg:py-2 py-3 pl-2 lg:px-3 rounded hover:bg-gray-200 hover:text-gray-800">
                            Playlists
                        </a>
                    </div>

                    <div class="text-sm lg:flex-shrink">
                        <a href="/login" class="block lg:inline-block lg:text-center lg:w-20 lg:mt-0 lg:px-3 lg:py-1 pl-2 py-3 rounded lg:uppercase lg:text-xs lg:font-semibold lg:hover:bg-blue-600 lg:hover:text-white hover:bg-gray-200 hover:text-gray-800">
                            Login
                        </a>
                        <a href="/register" class="block lg:inline-block lg:text-center lg:w-20 lg:text-white lg:mt-0 lg:ml-3 lg:px-3 lg:py-1 pl-2 py-3 rounded lg:uppercase lg:text-xs lg:font-semibold lg:bg-blue-600 lg:hover:bg-blue-500 lg:hover:text-white hover:bg-gray-200 hover:text-gray-800">
                            Register
                        </a>
                    </div>
                </div>
        ...
        <footer class="bg-gray-50 px-6 py-5">
            <div class="text-center text-sm">
                &copy; 2021 - Diony Busker
            </div>
        </footer>
